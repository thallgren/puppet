...
1 2\n3
  ...
  context 'when dealing with multi byte characters' do
    ...
    it 'produces character offsets that does not count each byte in a comment' do
      code = <<-"CODE"
      # \u{0400}\na
      CODE
    ...
    it 'produces character offsets that does not count each byte in value token' do
      code = <<-"CODE"
      '\u{0400}'\na
      CODE
...
describe Puppet::Pops::Parser::Lexer3 do
